 ...
 */
public class db11_1 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet db11_1</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            s = c.prepareStatement("UPDATE profiles SET name = ?,tel = ?,age = ?,birthday = ? WHERE profileID = ?;");
            
            s.setString(1,name);
            s.setString(2,tel);
            s.setInt(3,Integer.parseInt(age));
            s.setString(4,brt);
            s.setInt(5,Integer.parseInt(prof));
